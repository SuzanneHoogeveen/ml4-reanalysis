...
## Differences with ML4 main paper
...
```{r er23}
#what proportion american and us-born?
sum(merged$race=="1"&merged$countryofbirth=="1"&merged$expert=="1", na.rm = T)/sum(merged$expert=="1") 
sum(merged$race=="1"&merged$countryofbirth=="1"&merged$expert=="1"&merged$americanid>=7, na.rm = T)/sum(merged$expert=="1") 
```
